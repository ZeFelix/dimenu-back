# Generated by Django 2.0.7 on 2018-07-07 22:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_additional', models.BooleanField(verbose_name='Indicates whether or not an additional')),
        ...
        migrations.AlterUniqueTogether(
            name='customuser',
            unique_together={('is_client', 'cpf'), ('company', 'cpf')},
        ),
        migrations.AlterUniqueTogether(
            name='category',
            unique_together={('company', 'name')},
